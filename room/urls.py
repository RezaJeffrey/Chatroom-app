...
urlpatterns = [
    ...
    path('<str:room_name>/', views.RoomInsideView.as_view(), name='room_inside'),
    path('private/<str:room_name>/', views.PrivateRoomInsideView.as_view(), name='private_room_inside'),
